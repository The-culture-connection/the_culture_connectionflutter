...
class _EventsScreenState extends State<EventsScreen> {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                if (_searchText.isNotEmpty)
                  GestureDetector(
                    onTap: () {
                      ...
                      _performSearch(); // Reset to show all events
                    },
                    child: Container(
                ...
                // Search button
                GestureDetector(
                  onTap: _searchText.isNotEmpty ? _performKeywordSearch : null,
                  child: Container(
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'events found in your area. Try adjusting your location or search criteria.',
            style: TextStyle(
              color: Colors.grey,
              fontSize: 16,
            ),
  ...
  void _performSearch() {
    ...
    print('📍 Custom city: "$_customCity"');
    
    if (_useCurrentLocation && _currentPosition != null) {
      print('📍 Searching by coordinates: ${_currentPosition!.latitude}, ${_currentPosition!.longitude}');
      ...
      print('📍 Searching by city: "$_customCity"');
      _eventsService.searchEvents(
      ...
      print('⚠️ No search parameters available');
    }
  }

  void _performKeywordSearch() {
    if (_searchText.isEmpty) {
      _performSearch();
      return;
    }
    
    print('🔍 Performing keyword search for: "$_searchText"');
    ...
    if (_useCurrentLocation && _currentPosition != null) {
      ...
      print('⚠️ No location available for keyword search');
    }
  }
  ...
  void _showLocationPicker() {
    showModalBottomSheet(
      ...
      builder: (context) => _LocationPickerView(
        onCitySelected: (city) {
          print('🏙️ City selected: "$city"');
          setState(() {
            _customCity = city;
            _useCurrentLocation = false;
          });
          print('🏙️ Updated state - Custom city: "$_customCity", Use current location: $_useCurrentLocation');
          _performSearch();
        },
      ),
    );
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: _cityController.text.isNotEmpty
                          ...
                          : null,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _cityController.text.isNotEmpty 
                            ? const Color(0xFFFF7E00) 
                            : Colors.grey,
                        foregroundColor: Colors.white,
                        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
